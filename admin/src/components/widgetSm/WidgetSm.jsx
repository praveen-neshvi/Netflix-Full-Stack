  ...
  useEffect( ()=> {
    const getNewUsers = async ()=>{
      ...
      const res = await axios.get("/users?new=true", {
        headers: {
          token:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjYxNWY0NGJmOWY4YjRkOTE5NDMyZTc5NSIsImlzQWRtaW4iOnRydWUsImlhdCI6MTYzNDI4NDA0NywiZXhwIjoxNjM0NzE2MDQ3fQ.uQ5jLlp7YEklf8jReRYWeiH7m4sVWU2Z7m6IRElJ-bI"
        },
      });
